...
enum {
	parameter_volume,
	parameter_master_tune,
	parameter_portamento,
	parameter_mod_mix,
	parameter_vco1_mod,
	parameter_vco1_coarse,
	parameter_vco1_fine,
	parameter_vco1_wave,
	parameter_vco1_pw,
	parameter_vco1_level,
	parameter_vco2_mod,
	parameter_vco2_coarse,
	parameter_vco2_fine,
	parameter_vco2_wave,
	parameter_vco2_pw,
	parameter_vco2_level,
	parameter_vco3_kbd_ctrl,
	parameter_vco3_coarse,
	parameter_vco3_fine,
	parameter_vco3_wave,
	parameter_vco3_pw,
	parameter_vco3_level,
	parameter_noise_color,
	parameter_noise_level,
	parameter_vcf_mod,
	parameter_vcf_kbd_ctrl,
	parameter_vcf_cutoff,
	parameter_vcf_resonance,
	parameter_vcf_contour,
	parameter_vcf_attack,
	parameter_vcf_decay,
	parameter_vcf_sustain,
	parameter_vcf_release,
	parameter_vca_attack,
	parameter_vca_decay,
	parameter_vca_sustain,
	parameter_vca_release,
	parameter_a440,
};
...
void tibia_set_parameter(void *vinstance, size_t index, float value) {
	...
	case parameter_volume:
	{
		...
		break;
	case parameter_master_tune:
		instance->master_tune = value;
		break;
	case parameter_portamento:
	{
...
void tibia_process(void *vinstance, const float **inputs, float **outputs, size_t n_samples) {
	...
	for (size_t i = 0; i < n_samples; ) {
		...
		if (sync) {
			// Sample before advancing: n depends on the host's block boundaries.
...
static void update_note_gate(void *vinstance) {
	synth_mono *instance = (synth_mono*) vinstance;
	for (int i = 0; i < 128; i++)
...
static void note_on(void *vinstance, char note) {
	synth_mono *instance = (synth_mono*) vinstance;
	instance->notes_pressed[(int)note] = 1;
	update_note_gate(instance);
}

static void note_off(void *vinstance, char note) {
	synth_mono *instance = (synth_mono*) vinstance;
